...
int main(int argc, char **argv){
    ...
    tf::StampedTransform worldHeadCameraTransform = lookupTransformFromWorld("world","headCamera");
    tf::StampedTransform headCameraVictimTransform = lookupTransformFromWorld("headCamera","victim");
	...
	tf::Quaternion tfQuaternion(victimPose2.orientation.x, victimPose2.orientation.y, victimPose2.orientation.z, victimPose2.orientation.w);
