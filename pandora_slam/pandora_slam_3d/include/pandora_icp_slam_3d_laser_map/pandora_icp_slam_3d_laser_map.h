...
namespace pandora_slam_3d
{
	...
	class PandoraIcpSlam3d 
	{
		private:
			...
			PointCloud _octomapCloud;
			ros::Subscriber _octomapCloudSubscriber;
			boost::mutex _octomapCloudMutex;
			
			tf::Transform _currentTransform;
			tf::StampedTransform _laserToBaseFootprintTransform;
			...
			void octomapCloudCallback(const sensor_msgs::PointCloud2ConstPtr& msg);
